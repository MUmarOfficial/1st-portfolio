    ...
    return (
        <footer className="relative bg-black/40 backdrop-blur-md border-t border-white/10 mt-20 z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                    ...
                    <div className="space-y-4 text-center sm:text-left">
                        <a href="/" className="inline-block cursor-pointer">
                            <img
                                ...
                                className="h-12 sm:h-16 w-auto object-contain mx-auto sm:mx-0 hover:opacity-80 transition-opacity duration-200"
                            />
                        </a>
                        <p className="text-white/70 text-sm leading-relaxed max-w-xs mx-auto sm:mx-0">
                            {personalInfo.profession} crafting modern, performant web experiences with React, TypeScript, and cutting-edge technologies.
                        </p>
                    </div>
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map((link) => (
                                <li key={link.name}>
                                    <a
                                        href={link.href}
                                        className="text-white/70 hover:text-[#5227FF] transition-colors duration-200 text-sm cursor-pointer"
                                    >
                                        {link.name}
                                    </a>
                                </li>
                ...
                {/* Bottom Bar */}
                <div className="mt-8 sm:mt-10 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-white/50 text-xs sm:text-sm text-center md:text-left">
                        © {currentYear} {personalInfo.name}. All rights reserved.
                    </p>
                    <p className="text-white/50 text-xs sm:text-sm">
                        Built with <span className="text-[#5227FF]">React</span> & <span className="text-[#5227FF]">TypeScript</span>
                    </p>
                </div>
            </div>
        </footer>
